...
export const DEFAULT_GAME_OPTIONS = {
  ...
  enemy: {
    ...
    sparkSpeedBase: 0.034,
    sparkSpeedPerWave: 0.002,
    sparkHealthBase: 3,
    ...
    pulsarDamage: 25,
    colossusSpeed: 0.008,
    colossusHealthBase: 400,
    colossusAggroRange: 60,
    colossusShootInterval: 5200,
    colossusDamage: 18,
    colossusSpawnInterval: 10000,
  },
  base: {
    fireRange: 40,
    interactionRange: 18,
...
export const GAME_OPTION_SECTIONS = [
  ...
  },
  {
    ...
    fields: [
      ...
      { path: 'wave.colossusStartWave', label: 'Colossus Start Wave', min: 1, max: 100, step: 1 },
      { path: 'wave.colossusWaveInterval', label: 'Colossus Wave Interval', min: 1, max: 20, step: 1 },
    ],
  },
  {
    title: 'Enemy Units',
    fields: [
      ...
      { path: 'enemy.pulsarSpeed', label: 'Colossus Speed', min: 0.001, max: 0.2, step: 0.001 },
      { path: 'enemy.pulsarHealthBase', label: 'Colossus Health Base', min: 1, max: 500, step: 1 },
      { path: 'enemy.pulsarHealthPerWave', label: 'Colossus Health / Wave', min: 0, max: 20, step: 1 },
      ...
      { path: 'enemy.colossusSpeed', label: 'Colossus Speed', min: 0.001, max: 0.1, step: 0.001 },
      { path: 'enemy.colossusHealthBase', label: 'Colossus Health', min: 1, max: 2000, step: 1 },
      { path: 'enemy.colossusAggroRange', label: 'Colossus Aggro Range', min: 1, max: 200, step: 1 },
      { path: 'enemy.colossusShootInterval', label: 'Colossus Shoot Interval', min: 100, max: 20000, step: 50 },
      { path: 'enemy.colossusDamage', label: 'Colossus Damage', min: 1, max: 500, step: 1 },
      { path: 'enemy.colossusSpawnInterval', label: 'Colossus Escort Spawn Interval', min: 100, max: 60000, step: 100 },
    ],
  },
  {
